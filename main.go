...
import (
	...
	"trinhdaiphuc/ent-turtorial/ent"
	"trinhdaiphuc/ent-turtorial/ent/car"
	"trinhdaiphuc/ent-turtorial/ent/group"
	"trinhdaiphuc/ent-turtorial/ent/user"
)
...
func main() {
	dbName := "test"
	client, err := ent.Open(dialect.MySQL,
		fmt.Sprintf("root:password@tcp(127.0.0.1:3306)/%v?parseTime=true", dbName),
	)
	if err != nil {
